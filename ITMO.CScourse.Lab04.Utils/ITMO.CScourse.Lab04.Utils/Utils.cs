...
namespace ITMO.CScourse.Lab04.Utils
{
    public class Utils
    {
        ...
        //Calculate Factorial 
        //and return result as an out parameter
        public static bool Factorial (int n, out int answer)
        {
            ...
            {
                //If something goes wrong in the calculation, catch it here. All exceptions are handled the same way: 
                //set the result to zero and return false/
                f = 0;
                ok = false;
            }
            //Assign result value 
